...
<p">
    ...
    <p><button onclick="clickCounter()" type="button">Click me every time you visit the page!</button></p>
    <div id="result"></div>
    ...
    <ul>
        ...
        <li><a href="#f">fruits</a></li>
        <li><a href="#abc">fonts</a></li>
        <li><a href="#but">buttons</a></li>
        <li><a href="#j">jump</a></li>
        <li><a href="#a">"The place after the line thingies"</a></li>
    </ul>
...
<hr>
<img src="file:///var/folders/vm/h_dx184x27ggh011zd92fzmr0000gn/T/TemporaryItems/NSIRD_screencaptureui_9gxBb5/Screenshot%202024-07-24%20at%208.19.19%E2%80%AFPM.png">
<hr>
<h2 id="abc">fonts</h2>
...
<hr>
<h2 id="but">buttons</h2>
<p>Buttons!</p>
<button type="button" class="btn btn-default">White Button</button>
<button type="button" class="btn btn-primary">Dark Blue Button.</button>
<button type="button" class="btn btn-success">Green Button</button>
<button type="button" class="btn btn-info">Light Blue Button</button>
<button type="button" class="btn btn-warning">Orange Button</button>
...
<h2 id="j">jump</h2>
<p>um...</p>
<p>...why are there line Thingies?!?</p>
<a href="#a">Jump to the place after the line thingies</a>
<hr>
<hr>
<hr>
<hr>
...
<h2 id="a">the place after the line thingies</h2>
<p>We Escaped!</p>
<img src="bubandpc.png" alt="Bub the spider and Purple cube.">
<p>um...</p>
<alert>hello!</alert>
<video width="400" controls>
<source src="RedAndBlue.mp4" type="video/mp4">
